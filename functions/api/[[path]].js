    ...
    try {
      ...
      return new Response(
        JSON.stringify({
          ...
          meta: {
            isLiveApi: true,
            model: 'RestoAI Cloudflare Function',
            latencyMs: 140,
            timestamp: new Date().toISOString()
          }
        }),
    ...
    try {
      ...
      return new Response(
        JSON.stringify({
          success: true,
          data,
          meta: { isLiveApi: true, model: 'RestoAI Gastro Function', latencyMs: 160 }
        }),
        { headers: corsHeaders }
      );
    } catch (err) {
    ...
    try {
      ...
      return new Response(
        JSON.stringify({
          ...
          meta: { isLiveApi: true, model: 'RestoAI Care Function', latencyMs: 150 }
        }),
        { headers: corsHeaders }
      );
    } catch (err) {
